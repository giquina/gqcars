...
import { MapPin, Navigation, Clock, Calculator, Star, Car, Zap, Shield, Mic, MicOff, Volume2, VolumeX, Eye, Users, Sparkles, TrendingUp, Award, Gift, Compass, Router, Timer, Camera, Share2, Heart, Filter, RotateCcw, Play, Pause } from 'lucide-react'
...
export default function LocationBasedQuotes() {
  ...
  const initializeSpeechRecognition = () => {
    if ('webkitSpeechRecognition' in window || 'SpeechRecognition' in window) {
      ...
      speechRef.current = recognitionInstance;
    }
  }
