            ...
            <form className="space-y-4">
              <div>
                ...
                <input 
                  type="text" 
                  id="name" 
                  className="w-full px-4 py-2 bg-gray-800 border border-gray-700 rounded focus:ring-2 focus:ring-yellow-500 focus:border-transparent" 
                />
              </div>
              <div>
              ...
              <button 
                type="submit" 
                className="w-full bg-yellow-500 text-black py-2 px-4 rounded font-semibold hover:bg-yellow-600 transition-colors"
              >
                Send Message
              </button>
            </form>
