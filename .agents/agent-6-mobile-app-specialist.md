# 📱 Agent 6: GQ Cars Mobile App Specialist
...
### **Core Booking Flow:**
1. **Open App** → Select security service type
2. **Set Location** → Choose pickup/meeting location
3. **Choose Service** → Close Protection, Private Hire, Emergency
4. **Select Duration** → Hourly, daily, or custom timeframe
5. **Confirm Booking** → Instant confirmation with officer details
6. **Track Service** → Real-time tracking and communication
