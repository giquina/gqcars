    ...
    <>
      {isMinimized ? (
        <motion.button
          ...
          className="fixed bottom-6 right-6 z-51 w-16 h-16 bg-gradient-to-tr from-green-500 to-green-600 rounded-full flex items-center justify-center text-white shadow-2xl hover:scale-110 transition-all duration-300 group"
        >
        ...
        <motion.div
          ...
          className="fixed bottom-6 right-6 z-51 w-96 max-w-[90vw] bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden"
        >
          {/* Header */}
