...
import { Zap, Shield, Car, Phone, ArrowRight, Star } from 'lucide-react'
    ...
    <div className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-900 via-purple-900 to-black overflow-hidden">
      ...
      <div className="fixed top-6 left-6 z-50 bg-black/80 backdrop-blur-lg rounded-xl p-4 border border-yellow-500/30">
        ...
        <div className="space-y-1 text-xs text-gray-300">
          <div>🚗 {activeBookings} active bookings</div>
          <div>👤 {driversOnline} drivers online</div>
          <div>⚡ Avg response: 2.3min</div>
        </div>
      </div>
      ...
      <div className="relative z-10 container mx-auto px-4 py-20 text-center">
        ...
        {/* Explosive Badge */}
        <div className="inline-flex items-center bg-gradient-to-r from-yellow-500 to-orange-500 text-black font-bold px-6 py-3 rounded-full mb-8 animate-pulse shadow-xl">
          <Zap className="w-5 h-5 mr-2" />
          🔥 #1 SECURITY TRANSPORT IN LONDON 🔥
          <Zap className="w-5 h-5 ml-2" />
        </div>

        {/* Bold Title with Effects */}
        <h1 className="text-6xl md:text-8xl font-black mb-6 leading-tight">
          <span className="block text-white drop-shadow-2xl">GQ CARS</span>
        ...
        {/* Dynamic Subtitle */}
        <p className="text-xl md:text-3xl text-white mb-12 font-bold">
