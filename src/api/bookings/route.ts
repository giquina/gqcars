  ...
  try {
    ...
    const booking = await prisma.booking.create({
      data: {
        ...
        serviceType: validatedData.vehicleType,
        pickupLocation: validatedData.pickupAddress,
        destination: validatedData.destinationAddress,
        date: new Date(validatedData.scheduledDateTime),
        time: new Date(validatedData.scheduledDateTime).toTimeString(),
        securityLevel: validatedData.securityLevel,
        totalCost: estimatedPrice,
        notes: validatedData.specialRequirements,
        status: "pending"
      },
      include: {
        user: {
